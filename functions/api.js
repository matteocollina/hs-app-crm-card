...
router.get("/", (req, res) => {
  res.json({
    "results": [{
      "objectId": 245,
      "title": "Linea Magazzino",
      "link": "https://sales.pieri.it/66c27100-9ca6-428f-97dc-95a9c4c0025d_0/index.html",
      "created": "2021-12-09",
      "priority": "HIGH",
      "project": "API",
      "reported_by": "matteo.collina@diemmea.com",
      "description": "Quote in PE.",
      ...
      "properties": [{
        "label": "Created by",
        "dataType": "EMAIL",
        "value": "pierluigi.alexiadis@pieri.it"
      }],
      "actions": [{
        "type": "IFRAME",
        "width": 890,
        "height": 748,
        "uri": "https://sales.pieri.it/66c27100-9ca6-428f-97dc-95a9c4c0025d_0/document.pdf",
        "label": "Download PDF",
